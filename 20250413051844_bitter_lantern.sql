...
BEGIN
  ...
  -- Use crypt with the stored hash as the salt to verify the password
  -- This is the correct way to verify bcrypt hashed passwords
  IF crypt(p_password, v_doctor_auth.password) = v_doctor_auth.password THEN
    -- Update last login
